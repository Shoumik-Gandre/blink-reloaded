...
class BertEncoder(nn.Module):
    def __init__(self, bert_model: BertModel, output_dim: int, add_linear: bool=False):
    ...
    def forward(self, token_ids: torch.LongTensor, segment_ids: torch.LongTensor, attention_mask: torch.LongTensor) -> torch.Tensor:
...
class BiEncoderModule(torch.nn.Module):
    def __init__(self, params: BiEncoderModuleParams):
        ...
        self.context_encoder = BertEncoder(ctxt_bert, params["out_dim"], add_linear=params["add_linear"])
        self.cand_encoder = BertEncoder(cand_bert, params["out_dim"], add_linear=params["add_linear"])
...
class BiEncoderRanker(torch.nn.Module):
    ...
    def load_model(self, fname, device='cpu'):
