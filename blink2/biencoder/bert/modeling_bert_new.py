...
class BiEncoderModule(torch.nn.Module):
    def __init__(self, params: BiEncoderModuleParams):
        ...
        self.mention_encoder: BertModel = BertModel.from_pretrained(params["bert_model"])
        self.entity_encoder: BertModel = BertModel.from_pretrained(params['bert_model'])
        self.config = self.mention_encoder.config
