...
from ..data_types import EntityInput
from ..preprocess import tokenize_entity
...
class EntityEncoderPipeline(Pipeline):
    ...
    >>> extractor = pipeline(model=shomez/blink-biencoder-entity-encoder", task="feature-extraction")
